...
declare global {
  interface HTMLElementTagNameMap {
    ...
    // Lit/TS won't compile otherwise...
...
/**
 * Component that displays a full-featured store locator based on a list of
 * locations.
 *
...
export class StoreLocator extends BaseComponent {
   ...
   * documentation](https://developers.google.com/maps/documentation/get-map-id?utm_source=github&utm_medium=documentation&utm_campaign=&utm_content=web_components)
   ...
   * Builder
   * tool](https://pantheon.corp.google.com/google/maps-apis/build/locator-plus?utm_source=github&utm_medium=documentation&utm_campaign=&utm_content=web_components)
   * in the Maps Console.
   */
